...
class MainController extends GetxController {
  ...
  List<Widget> defineViews() {
    List<Widget> listviews = [];
    if (_auth.currentUser!.email!.contains('candidato')) {
      listviews = [
        UserRegister(),
      ...
      return listviews;
    } else if (_auth.currentUser!.email!.contains('director')) {
      listviews = [
        UserRegister(),
        const DownloadDBScreen(),
        AgendaRegister(),
      ...
      return listviews;
    } else if (_auth.currentUser!.email!.contains('secre')) {
      listviews = [UserRegister(), AgendaRegister(), FavoresRegister()];
      return listviews;
    } else if (_auth.currentUser!.email!.contains('gerente')) {
      listviews = [
        UserRegister(),
        const DownloadDBScreen(),
        AgendaRegister(),
      ...
      return listviews;
    } else if (_auth.currentUser!.email!.contains('asistente')) {
      listviews = [UserRegister(), FavoresRegister()];
      return listviews;
    }
    return listviews;
  }
...
//LEADER METHODS
  Future<String?> addLeader(Leader leader) async {
    ...
    if (exist != null) {
      ...
      if (firebaseUser!.email!.contains('alcaldia')) {
        colection = FirebaseFirestore.instance.collection('alcaldia');
  ...
  Future<Leader?> getoneLeader(String idLeader) async {
    ...
    if (firebaseUser!.email!.contains('alcaldia')) {
      ...
      Map<dynamic, dynamic> dataid =
          lideresdata.data() as Map<dynamic, dynamic>;
  ...
  Future<List<Votante>> getVotantes() async {
    ...
    if (firebaseUser!.email!.contains('alcaldia')) {
      ...
      Map<dynamic, dynamic> dataid =
          votantesdata.data() as Map<dynamic, dynamic>;
      dataid.forEach((key, value) {
